...
module.exports = async({ studiosToCreate, actorToCreate, reviewerToCreate, filmsToCreate = 10, reviewsToCreate = 10, } = {}) => {
  // creating  things
  ...
  const film = await Film.create([...Array(filmsToCreate)]
    .map(() => ({
